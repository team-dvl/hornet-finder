    ...
    <#elseif section = "form">
        <div id="kc-form-webauthn" class="${properties.kcFormClass!}">
            ...
            <div class="${properties.kcFormGroupClass!} no-bottom-margin">
                ...
                <#-- Velutina: recovery for passkey-only users, who get no "try another way" -->
                <#if realm.resetPasswordAllowed>
                    <div id="kc-form-options" class="${properties.kcFormOptionsWrapperClass!}">
                        <span><a tabindex="5" href="${url.loginResetCredentialsUrl}">${msg("velutinaLostPasskey")}</a></span>
                    </div>
                </#if>
            </div>
        </div>
