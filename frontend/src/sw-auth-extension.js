...
// Configuration - Réduire les logs en production
const TOKEN_CHECK_INTERVAL = 2 * 60 * 1000; // 2 minutes
const TOKEN_WARNING_THRESHOLD = 90 * 1000; // 90 secondes avant expiration
const VERBOSE_LOGGING = self.location.hostname.includes('dev'); // Logs détaillés seulement en dev
