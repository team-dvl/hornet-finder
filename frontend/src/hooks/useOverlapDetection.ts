...
/** Map objects as listed in the overlap sheet */
// Fonction pour convertir un frelon en MapObject
export function hornetToMapObject(hornet: Hornet): MapObject {
  const colors: string[] = [];
...
export function apiaryToMapObject(apiary: Apiary): MapObject {
...
export function nestToMapObject(nest: Nest): MapObject {
  return {
...
export function trapToMapObject(trap: Trap): MapObject {
  return {
    id: trap.id,
