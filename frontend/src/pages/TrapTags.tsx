...
import { fetchFreeTags, generateTags, TagError, type PrintableTag } from '../utils/tagsApi';
...
/**
 * Printing sheet of QR tags. The tags are generated blank; each one is then
 * attached to a trap by scanning it from the map.
 */
export default function TrapTags() {
        ...
        <div className="d-print-none">
          ...
          {batch.length > 0 && (
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <Button variant="outline-primary" size="sm" onClick={() => print('batch')}>
                <i className="bi bi-printer me-1" aria-hidden="true" />Imprimer
              </Button>
            </div>
          )}
        </div>
        ...
        <div className="d-print-none mt-4">
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            {reprintable.length > 0 && (
              <Button variant="outline-secondary" size="sm" onClick={() => print('free')}>
                <i className="bi bi-printer me-1" aria-hidden="true" />Réimprimer
              </Button>
            )}
          </div>
