...
import {
  fetchAdminTagQr, fetchAdminTags, fetchTagKeyUsage, revokeTag, TagError,
...
/**
 * Administration of the QR Codes: usage of each signing key (before retiring
 * one), every QR Code with its state, reprinting and revocation.
 */
